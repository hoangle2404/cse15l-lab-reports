...
* For the output, when running cat command without any arguments, nothing happens and it is just a blank page. When I input something later, the output is exactly what I input. We can stop the execution ò the command using Ctrl + c.   
