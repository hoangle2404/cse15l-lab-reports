...
* The getPath() and getQuery() do not take any arguments. But the split() method takes '=' as an argument, contain() takes /add-message as an argument, and equal() takes / as an argument.
